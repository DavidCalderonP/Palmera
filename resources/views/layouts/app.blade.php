                    ...
                    <li class="nav-item">
                        ...
                        <li class="nav-item">
                            <div class="input-group mb-2">
                                ...
                                <form action="{{url('/productos/search')}}" class="form-inline" method="POST">
                                    @csrf
                                    <input name="search" type="text" class="form-control" placeholder="Buscar." aria-label="Username" aria-describedby="basic-addon1">
